 ...
 */
 ...
 /*@bgen(jjtree) equalsOldIDNewID */
  ...
  private boolean jj_3R_241() {
    ...
    if (jj_scan_token(END)) return true;
    xsp = jj_scanpos;
    if (jj_scan_token(402)) jj_scanpos = xsp;
    if (jj_scan_token(4)) return true;
    return false;
  }
  ...
  private int jj_la;
  private int jj_gen;
  final private int[] jj_la1 = new int[405];
  ...
  public PLSQLParser(java.io.InputStream stream, String encoding) {
    ...
    jj_ntk = -1;
    jj_gen = 0;
    for (int i = 0; i < 405; i++) jj_la1[i] = -1;
...
/** Get the specific Token. */
  ...
  public ParseException generateParseException() {
    jj_expentries.clear();
    boolean[] la1tokens = new boolean[416];
    if (jj_kind >= 0) {
