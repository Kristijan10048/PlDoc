...
CREATE OR REPLACE PACKAGE pkg_datetime_literals AS 
  ...
  */
  ...
  v_duration_ds_hhmm INTERVAL DAY TO SECOND := INTERVAL '12' HOUR;
  v_duration_ds_hhss INTERVAL DAY TO SECOND := INTERVAL '30:06.123456' MINUTE TO SECOND;
  v_duration_ds_hhss INTERVAL DAY TO SECOND := INTERVAL '30' MINUTE;
END;
/
